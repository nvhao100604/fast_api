...
class Job(Base):
    ...
    EducationLevel: Mapped[Optional[EducationLevelEnum]] = mapped_column(SQLEnum(EducationLevelEnum),
    ...
    batches: Mapped[List["ScreeningBatch"]] = relationship(back_populates="job", cascade="all, delete-orphan")